# BSP STM32-HTS221 Component

![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32-hts221.svg?color=brightgreen)
...
This **stm32-hts221** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **STM32-HTS221** BSP MEMS component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32-hts221/blob/main/Release_Notes.html).
